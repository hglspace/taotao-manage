...
public class PicUploadController {
    ...
    public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response)
        ...
        // 生成图片的绝对引用地址
        String picUrl = StringUtils.substringAfter(filePath, propertiesService.IMAGE_UPLOADPATH);
        fileUploadResult.setUrl(propertiesService.IMAGE_HTTPPATH + picUrl);
    ...
    private String getFilePath(String sourceFileName) {
        String baseFolder = propertiesService.IMAGE_UPLOADPATH + File.separator + "images";
